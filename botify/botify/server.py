...
user_liked_tracks = Redis(app, config_prefix="REDIS_USER_LIKED_TRACKS")
user_unliked_tracks = Redis(app, config_prefix="REDIS_USER_UNLIKED_TRACKS")
...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        if treatment == Treatment.T1:
            recommender = CustomRecommender(recommendations_dssm.connection, user_liked_tracks.connection,
                                            user_unliked_tracks.connection, catalog,
                                            Contextual(recommendations_contextual.connection, catalog,
