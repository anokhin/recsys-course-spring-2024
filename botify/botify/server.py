...
from botify.recommenders.RandomWalkIndexed import RandomWalkIndexed
...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        if treatment == Treatment.T1:
            ...
            dssm = Indexed(recommendations_dssm.connection, catalog, contextual)
            recommender = RandomWalkIndexed(recommendations_dssm.connection, catalog, dssm)
