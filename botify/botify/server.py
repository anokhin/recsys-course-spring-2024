...
from botify.recommenders.betterIndexed import BetterIndexed
...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        if treatment == Treatment.T1:
            recommender = BetterIndexed(recommendations_dssm.connection, tracks_redis.connection, artists_redis.connection, catalog, Random(tracks_redis.connection))
        else:
