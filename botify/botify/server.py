...
from botify.recommenders.HWRecommender import HWRecommender
...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        if treatment == Treatment.T1:
            recommender = HWRecommender(recommendations_dssm.connection, catalog, Random(tracks_redis.connection))
        else:
