...
from botify.recommenders.reference import Reference
...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        treatment = Experiments.REFERENCE.assign(user)

        if treatment == Treatment.T1:
            recommender = Reference(
                recommendations_dssm=recommendations_dssm.connection,
                recommendations_contextual=recommendations_contextual.connection,
                catalog=catalog,
